...
const Doc: FC = () => {
  ...
  const enterFullScreen = () => {
    ...
    (categoryRef.current! as HTMLDivElement).classList.add(
      `${styles.fullScreen}`
    );
  };
  ...
  const exitFullScreen = () => {
    ...
    (categoryRef.current! as HTMLDivElement).classList.remove(
      `${styles.fullScreen}`
    );
  };
  return (
    <div className={styles.doc} ref={categoryRef}>
      ...
      <Layout className={styles["doc-container"]}>
        <Sider theme={"light"} className={styles.sider} width={"25%"}>
          <Title level={3}>我是模板文档</Title>
          <Category data={data} />
          <div
          ...
          <Typography>
            ...
            <Paragraph>
              <ul>
                ...
                <li>
                  <Link to="/docs/spec/overview">Patterns</Link>
                </li>
                <li>
                  <Link to="/docs/resources">Resource Download</Link>
                </li>
              </ul>
            </Paragraph>
